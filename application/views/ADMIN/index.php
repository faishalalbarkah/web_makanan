...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-lg"><b>ADMIN</b><?php echo $this->session->userdata("username"); ?></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <span class="hidden-xs">Welcome,<?php if($this->session->has_userdata("username")) { ?><?php echo $this->session->userdata("username"); ?><?php } ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url(); ?>Adminlogin/logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>AdminMain/index"><i class="fa fa-circle-o"></i>Produk</a></li>
            <li><a href="<?php echo base_url(); ?>AdminMain/tampil_datajual"><i class="fa fa-circle-o"></i>Penjualan</a></li>
            <li><a href="<?php echo base_url(); ?>AdminMain/tampil_databayar"><i class="fa fa-circle-o"></i>Pembayaran</a></li>
          </ul>
        </li>
        <!-- <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="advanced.html"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
             ...
             <li class="active"><a href=""><i class="fa fa-circle-o"></i>laporan Penjualan</a></li>
        ...
        <li>
          <a href="">
            <i class="fa fa-cogs"></i> <span>Ubah Password Admin</span>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-NOW Bababa</strong>
     <strong>
       <!--ON clock Tiime-- >
